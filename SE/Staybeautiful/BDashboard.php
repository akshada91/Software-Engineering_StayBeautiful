...
<html lang="en">
  ...
  <!-- / Promo section -->
  <h1 style="color:purple";><strong><center>Welcome!</center></strong></h1>
  <h2 style="color:purple";><strong><center>Best Sellers</center></strong></h2>
  ...
  <p align="center">
  <button class="button" type="submit" value="Report">Purchase Report</button>
  </p>
  <?php
	...
	if($result = $conn->query("SELECT * FROM address where ID=1"))
	{
		...
		$conn->close();
  ?>
  <h2><center><a href='BuyerInformationUpdate.php?ID=1'>Update Personal Information</a></center></h2>
  </p>
  <!-- footer -->  
  <footer id="aa-footer">
    <!-- footer bottom -->
