...
<!-- Start header section -->
  ...
  <!-- / header section -->
<div class="container">
    <h1 class="well">Buyer Registration Form</h1>
	...
	<div class="col-lg-12 well
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								...
								<input type="text" placeholder="Enter Desired Username Here.." class="form-control">
							</div>
							<div class="col-sm-6 form-group">
						...
						<div class="form-group">
						<h3><b>Select a Secret Question?</b></h3>
						...
						<div class="form-group">
						<h3><b>Write a Secret Answer</b></h3>
						<input type="text" placeholder="Enter Your Answer Here.." class="form-control" >	
						</div>
						<div class="row">
		 ...
		 <h3 class="well">Preferences</h3>
					...
					<div class="form-group">
						...
						<label class="checkbox-inline"><input type="checkbox" value="">Red</label></div>

						<div><label>gender: </label>	
							<label class="radio-inline"><input type="radio"	value="">Men</label>	
							<label class="radio-inline"><input type="radio"	value="">Women</label>
						</div>					
					</div>	
					
					<div><button type="button" class="btn btn-lg btn-info">Submit</button>		</div>			
					</div>
				</form> 
				</div>
	</div>
